...
```{r }
anova_results <- anova(me_intercepts, me_slopes, me_interceptslopes, me_subjectintercept, me_subjectinterceptslope)
bic_results <- BIC(me_intercepts, me_slopes, me_interceptslopes, me_subjectintercept, me_subjectinterceptslope)
...
Averages all converge, but there's still structure when you take Subjects into accout because they're still consistent across their trials.
