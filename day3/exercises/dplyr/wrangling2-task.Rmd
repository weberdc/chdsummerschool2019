...
# your code here
N %>% 
  rnorm() %>%  # could skip the () on rnorm() and mean() if you want, "BUT DON'T!"
  mean()
```

By default, the pipe operator assumes that the input takes the place of the *first* argument in the function. So let's suppose I want to calculate the 20% trimmed mean, of normally distributed numbers with mean 100 and standard deviation 15. Here's the traditional version:
