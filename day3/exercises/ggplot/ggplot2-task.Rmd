...
beaches %>% ggplot(
  aes(x = date, y = temperature, colour = temperature)
) +
geom_line() +
scale_color_distiller(palette = "OrRd") # reverse?
```
...
beaches %>% ggplot(
  aes(x = date, y = temperature, colour = season_name)
) +
geom_point()
```
...
beaches %>% ggplot(
#  aes(x = date, y = temperature, colour = paste0(year,month_name))
  aes(x = date, y = temperature, colour = season_name, group = month_num)
) +
geom_line()
...
beaches %>% ggplot(
  aes(x = date, y = temperature, colour = reorder(season_name, season), group=month_num)
) +
geom_line()
```
...
geom_line() +
scale_color_brewer(palette = "Dark2") + # reverse?
labs(colour="Season")
